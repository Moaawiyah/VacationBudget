...
function foldOther(data: CategorySpend[], otherLabel: string) {
  ...
  return [
    ...
    { name: otherLabel, amount: otherTotal },
  ];
}
            ...
            >
              <LabelList
                ...
                formatter={(value: string | number | boolean | null | undefined) =>
                  formatCurrency(Number(value ?? 0), currency, bcp47)
                }
